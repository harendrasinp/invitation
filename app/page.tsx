...
export default function Home() {
  ...
  const handleSubmit = (e: any) => {
    ...
    const audio = new Audio("/sound/bgsound2.mp3");
    audio.loop = true;
  ...
  return (
    <div className="h-screen w-full p-2">
      ...
      <div className="flex flex-col items-center justify-center mt-1 ">
        ...
        <p className="text-orange-500 mb-2 font-dancing text-2xl text-center">
          Join us for the inauguration of our new House.
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center">
          ...
          <button
            type="submit"
            className="mt-2 px-4 py-2 bg-orange-400 text-white rounded-lg hover:bg-pink-700 transition duration-300"
          >
            Open Invitation
          </button>
        </form>
